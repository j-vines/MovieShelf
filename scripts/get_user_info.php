<?php
	...
	$display_search = "SELECT display_name FROM user WHERE iduser ='".$_POST["userid"]."';";
	...
	$bio_search = "SELECT bio FROM user WHERE iduser ='".$_POST["userid"]."';";
	...
	$date_search = "SELECT joined FROM user WHERE iduser ='".$_POST["userid"]."';";
	...
	$lastlogin_search = "SELECT last_login FROM user WHERE iduser ='".$_POST["userid"]."';";
